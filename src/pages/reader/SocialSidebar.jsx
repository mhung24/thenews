...
const SocialSidebar = ({ isBookmarked, setIsBookmarked, commentCount }) => {
  return (
    <div className="hidden lg:block lg:col-span-1">
      <div className="sticky top-24 flex flex-col gap-4 items-center">
        ...
        <button
          ...
          className={`w-10 h-10 rounded-full border flex items-center justify-center transition shadow-sm ${
            isBookmarked
